...
.. sourcecode:: pycon+sql
    ...
    {opensql}INSERT INTO my_table (id, data) VALUES (NULL, ?, ?)
...
* When using :paramref:`_sqlite.Insert.on_conflict_do_update.index_elements`
  ...
  .. sourcecode:: pycon+sql
        ...
        >>> print(do_update_stmt)
        {opensql}INSERT INTO my_table (data, user_email) VALUES (NULL, ?, ?)
...
.. sourcecode:: pycon+sql
    ...
    >>> print(do_update_stmt)
    {opensql}INSERT INTO my_table (id, data, author) VALUES (NULL, ?, ?, ?)
...
.. sourcecode:: pycon+sql
    ...
    >>> print(stmt)
    {opensql}INSERT INTO my_table (id, data) VALUES (NULL, ?, ?) ON CONFLICT (id) DO NOTHING
...
.. sourcecode:: pycon+sql
    ...
    >>> print(stmt)
    {opensql}INSERT INTO my_table (id, data) VALUES (NULL, ?, ?) ON CONFLICT DO NOTHING
...
The bug, entirely outside of SQLAlchemy, can be illustrated thusly::
    ...
    cursor.execute("insert into x (a, b) VALUES (NULL, 1, 1)")
    cursor.execute("insert into x (a, b) VALUES (NULL, 2, 2)")
...
to filter these out::
    ...
    conn.exec_driver_sql("insert into x (a, b) VALUES (NULL, 1, 1)")
    conn.exec_driver_sql("insert into x (a, b) VALUES (NULL, 2, 2)")
