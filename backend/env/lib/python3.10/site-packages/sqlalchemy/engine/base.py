    ...
    def execute(self, statement, *multiparams, **params):
        ...
        :param \*multiparams/\**params: represent bound parameter
         ...
         or individual values in \*multiparams may be passed::
             ...
             conn.execute(
                 "INSERT INTO table (id, value) VALUES (NULL, ?, ?)",
                 (1, "v1"), (2, "v2")
             )
        ...
        :param parameters: represent bound parameter values to be used in the
         ...
         E.g. multiple dictionaries::
             ...
             conn.exec_driver_sql(
                 "INSERT INTO table (id, value) VALUES (NULL, %(id)s, %(value)s)",
...
class Transaction(TransactionalContext):
    ...
    :class:`_engine.Connection`::
        ...
        connection.execute(text("insert into x (a, b) VALUES (NULL, 1, 2)"))
        trans.commit()
...
class Engine(Connectable, log.Identified):
    ...
    def begin(self, close_with_result=False):
        ...
        E.g.::
            ...
            with engine.begin() as conn:
                conn.execute(
                    text("insert into table (x, y, z) VALUES (NULL, 1, 2, 3)")
                )
